...
extern "C"{
void Java_org_cocos2dx_cpp_AppActivity_nativeStartSession(JNIEnv*  env, jobject thiz)
{
	Analytics::getInstance()->startSession();
}

void Java_org_cocos2dx_cpp_AppActivity_nativeStopSession(JNIEnv*  env, jobject thiz)
{
